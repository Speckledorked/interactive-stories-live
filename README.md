...
| Downtime completion rewards (gold/items/reputation/contacts) | 1 | Generated by the AI, stored verbatim, never applied to `Character.resources` or `FactionStanding` — a dead letter, not an oversight (`#74`, open). |
