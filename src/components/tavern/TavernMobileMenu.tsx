...
// flat list.
//
// This used to carry a `variant` prop selecting between a flat
// myth-surface drawer and a dark gradient one; every page is on the myth
    ...
    <div className="space-y-0.5">
      {group.map((link) => (
        <Link
          ...
          href={link.href}
          onClick={onClose}
          className={`flex min-h-[44px] items-center gap-3 rounded-lg px-3 py-2.5 transition-colors ${
            link.isActive
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      >
        ...
        >
          <h2 className="font-display text-lg text-myth-ink">Menu</h2>
          <IconButton
            icon={X}
            label="Close menu"
            className="-mr-2"
