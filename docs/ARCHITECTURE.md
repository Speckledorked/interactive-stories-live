...
2. **Keep broadening API route test coverage.** #93, #134, and #135 have
   ...
   safety/moderation, scene-action, and social/notification tiers (see the
   Scorecard row); ~44 routes remain untested — health checks, admin
...
- **API route test coverage** — targeted coverage exists for the
  ...
  password family plus the safety/moderation, scene-action, and social/
  notification tiers (see the Scorecard) — but ~44 lower-risk routes
