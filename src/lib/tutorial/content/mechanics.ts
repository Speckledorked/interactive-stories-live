...
export const MECHANICS: readonly Mechanic[] = [
  ...
  },
  {
    ...
    body: [
      'Writing a scene costs real money. You are charged for it.',
      ...
      'The world turn also does work while nobody is playing, and it is deliberately kept cheap: most of it is plain calculation with no narration involved at all.',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'Almost all of that is plain calculation rather than invention, and it is deterministic: the same world in the same state produces the same turn. That is what makes it a simulation you can reason about rather than a random event generator. What MythOS adds on top is the narration of it.',
  ...
  },
  {
    ...
    body: [
      ...
      'Rewriting is done from the facts, not by asking MythOS to reimagine the entry, so an entry cannot drift away from what the simulation actually says. Entries keep a history of what changed and when, and link to each other — a person to their faction and the place they are, a faction to the ground it holds.',
  ...
  // ----------------------------------------------------------------- behind
  {
    ...
    body: [
      ...
      'The guarantee it exists to demonstrate: the outcome was settled before the prose was written. The narrator is describing a result, not choosing one. If a scene went badly, the panel will show you why, and the answer will not be that MythOS felt like it.',
    ],
    aliases: ['what changed', 'transparency', 'roll', 'dice', 'why did that happen', 'receipt', 'how it was decided', 'proof'],
