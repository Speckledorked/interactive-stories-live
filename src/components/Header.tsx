            ...
            <>
              <nav className="hidden md:flex items-center space-x-2">
                ...
                <div className="flex items-center gap-3">
                  <div className="px-3 py-1.5 bg-dark-800/50 rounded-lg border border-dark-700/50 max-w-[180px] lg:max-w-xs overflow-hidden">
                    <span className="text-sm text-gray-400 font-medium truncate block">{user?.email}</span>
                  </div>
                  <button
              ...
              <div className="flex items-center gap-2 md:hidden">
                ...
                >
                  ...
                  {unreadCount > 0 && (
                    <span className="absolute -top-0.5 -right-0.5 bg-gradient-to-r from-danger-600 to-danger-500 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center shadow-lg shadow-danger-500/30 animate-pulse">
                      {unreadCount > 9 ? '9+' : unreadCount}
                    </span>
                  )}
                </button>
