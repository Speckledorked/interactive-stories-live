...
are folded in below. `#22` (de-jargon), `#23` (surface multiplayer), `#45`/`#75` (structured quest objectives and a real quest-giver FK) and `#96`/`#97` (tick-order and succession tests, which restored two 5s honestly) shipped — see Shipped below. What a FAILED or ABANDONED quest should *cost* is still open; the structure to answer it now exists.
